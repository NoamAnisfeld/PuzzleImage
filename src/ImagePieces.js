...
import { piecePath, dataUrlShapeFromPath, ORIENTATION, CURVE_DIRECTIONS } from './puzzleCurvePaths';

function generateCurvesGrid({ imageWidth, imageHeight, rows, cols, curveSize }) {
